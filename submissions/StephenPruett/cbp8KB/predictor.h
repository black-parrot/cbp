...
#define TAG_SIZE 15
uint32_t bestConfig[NHIST+1] =     {0,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2};

#define PRINT_CONFIG false

//reconfiguration parameters for HPS
#define USEFUL_THRESHOLD 0.7
#define NUM_RECONFIGS 6
#define CONFIG_THRESH_MISPRED 5
#define BIMOD_ALLOC false
#define CONTINUOUS_RECONFIG true
#define SNAPSHOT_PERIOD 100000
